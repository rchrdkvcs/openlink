  ...
  <section>
    ...
    <div class="mt-6 space-y-5">
      <div
        ...
        class="rounded-md border border-success/25 bg-success/10 px-4 py-3 text-sm text-success"
      >
      ...
      <div v-else-if="twoFactor.pendingSecret" class="space-y-4">
        <div class="rounded-md border border-warning/25 bg-warning/10 p-4">
          ...
          <code
            class="mt-3 block break-all rounded-md border bg-background px-3 py-2 font-mono text-sm text-foreground"
            >{{ twoFactor.pendingSecret }}</code
          >
          <p v-if="twoFactor.otpauthUrl" class="mt-2 break-all font-mono text-xs text-faint">
