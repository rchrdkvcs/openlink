...
<template>
    <section>
        ...
        <div class="mt-5 grid gap-3 sm:grid-cols-2">
            ...
            >
                ...
                <span class="min-w-0 flex-1">
                    <span class="block truncate text-sm font-medium text-foreground">{{ providerLabels[identity.provider] ?? identity.provider }}</span>
        ...
        <div class="mt-4">
            <Button type="button" variant="secondary" :disabled="profileAvatar.source_id === null || form.processing" @click="select(null)">
                Use initials
            </Button>
        </div>
    </section>
