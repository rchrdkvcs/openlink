...
<template>
    ...
    <main class="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4">
        ...
        <section class="relative w-full max-w-xl animate-slide-up text-center">
            ...
            <span class="inline-flex items-center gap-1.5 rounded-full bg-accent/15 px-2.5 py-0.5 text-xs font-medium text-accent">
            ...
            <p v-if="!done" class="mt-8 text-[13px] text-faint">Goes live {{ activationLabel }} · this page will redirect automatically.</p>
        </section>
    </main>
</template>
