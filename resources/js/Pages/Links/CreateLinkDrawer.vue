    ...
    <Drawer :show="show" @close="emit('close')">
        <template #header>
            <div class="flex min-w-0 items-center gap-3">
                ...
                <div class="min-w-0">
                    ...
                    <p class="truncate text-xs text-faint">Paste a destination, shape the short URL, add options as you need them.</p>
                </div>
            </div>
        </template>
        ...
        <form class="flex min-h-full flex-col" @submit.prevent="emit('submit')">
            <div class="flex-1 space-y-5 p-5">
                ...
                <!-- Active option rows -->
                <TransitionGroup v-if="activeOptions.length" tag="div" class="space-y-3" enter-active-class="animate-slide-up">
                    <OptionRow
                    ...
                    >
                        ...
                        <template v-else-if="key === 'password'">
                            ...
                            <p v-if="form.errors.password" class="mt-1.5 text-xs text-danger">{{ form.errors.password }}</p>
                        </template>
                        ...
                        <template v-else-if="key === 'folder_id'">
                            ...
                            <p v-if="form.errors.folder_id" class="mt-1.5 text-xs text-danger">{{ form.errors.folder_id }}</p>
                        </template>
