...
watch(() => props.modelValue, () => (faviconFailed.value = false));
...
<template>
    <div>
        ...
        >
            <img v-if="faviconSrc" :src="faviconSrc" alt="" class="h-5 w-5 shrink-0 rounded bg-elevated" @error="faviconFailed = true" />
