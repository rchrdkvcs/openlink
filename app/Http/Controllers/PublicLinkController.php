...
{
    public function show(Request $request, string $slug, PublicResolutionService $resolver, InstanceSettings $settings): \Symfony\Component\HttpFoundation\Response
    {
        return $this->toResponse($request, $resolver->resolve($request, $slug), $settings);
    }

    public function qr(Request $request, QrCode $qrCode, PublicResolutionService $resolver, InstanceSettings $settings): \Symfony\Component\HttpFoundation\Response
    {
    ...
    public function password(Request $request, ShortLink $shortLink, PublicResolutionService $resolver, AnalyticsService $analytics, InstanceSettings $settings): \Symfony\Component\HttpFoundation\Response
    {
        ...
        return $this->toResponse($request, $resolver->resolve($request, $shortLink->slug, $qrCode), $settings);
    }

    private function toResponse(Request $request, \App\Services\ResolutionResult $result, InstanceSettings $settings): \Symfony\Component\HttpFoundation\Response
    {
