                ...
                <TransitionGroup v-if="activeOptions.length" tag="div" class="space-y-3" enter-active-class="animate-slide-up">
                    ...
                    >
                        <template v-if="key === 'activates_at' || key === 'expires_at'">
                            ...
                            <p v-if="editForm.errors[key]" class="mt-1.5 text-xs text-danger">{{ editForm.errors[key] }}</p>
                        </template>
                        ...
                        <template v-else-if="key === 'folder_id'">
                            ...
                            <p v-if="editForm.errors.folder_id" class="mt-1.5 text-xs text-danger">{{ editForm.errors.folder_id }}</p>
                        </template>
